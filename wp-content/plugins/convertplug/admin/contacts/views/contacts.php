													...
													<tbody id="the-list" class="smile-style-data">
														...
														if ( ! empty( $contacts ) ) {
															foreach ( $contacts as $key => $list ) {
																...
																?>
																<tr>  
																	<td scope="col" class="manage-column column-name" data-href="<?php echo esc_attr( esc_url( $name_url ) ); ?>" ><span class="connect-list-gravtar-img"><?php echo get_avatar( $email, '96', 'https://support.brainstormforce.com/wp-content/uploads/2015/07/default-gravtar.png' ); ?></span><?php echo esc_attr( $name ); ?></td>
																	<td scope="col" class="manage-column column-email" data-href="<?php echo esc_attr( esc_url( $email_url ) ); ?>; ?>"><?php echo esc_attr( $email ); ?></td>
																	<td scope="col" class="manage-column column-date" data-href="<?php echo esc_attr( esc_url( $date_url ) ); ?>"><?php echo esc_attr( $date ); ?></td>
