				...
				<table class="wp-list-table widefat fixed bsf-connect-optins bsf-connect-optins-campaign">
					...
					<tbody id="the-list" class="smile-style-data">
						...
						<td class="actions column-actions" style="vertical-align: inherit;">
							...
							<input type="hidden" id="delete-list-nonce" value="<?php echo esc_attr( $delete_list_nonce ); ?>" />
	...
	<div class="row">
		<div class="container" style="max-width:100% !important;width:100% !important;margin-top: 41px !important;">
			<div class="col-sm-6">
				...
				?>
				<a class="button-primary bsf-connect-add-contact-list" href="<?php echo esc_attr( esc_url( $new_list_url ) ); ?>;" title="<?php esc_html_e( 'Create new list', 'smile' ); ?>"><?php esc_html_e( 'Create New Campaign', 'smile' ); ?></a>
