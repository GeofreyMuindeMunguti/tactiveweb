...
class Admin {
	...
	public function plugin_action_links( $links ) {
        ...
        $links['active_license'] = sprintf( '<a href="%s" class="elementor-plugins-gopro" target="_blank" >%s</a>', \Elementor\Utils::get_pro_link( 'https://elementor.com/pro/?utm_source=wp-plugins&utm_campaign=gopro&utm_medium=wp-dash'), __( 'Purchase Elementor Pro', 'elementor-pro' ) );
		return $links;
		$license_key = self::get_license_key();
